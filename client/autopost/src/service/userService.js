...
export const register = async (userName, userPassword, userEmail) => {
  const endpoint = 'https://onlypostsai.com/api/register';
  try {
...
export const login = async (userName, userPassword, userEmail) => {
  const endpoint = 'https://onlypostsai.com/api/login';
...
export const getUpdatedDetails = async (userName, userJwt) => {
  const endpoint = 'https://onlypostsai.com/api/updateddetails';
...
export const getUserCreds = async (username, userJwt) => {
  const endpoint = 'https://onlypostsai.com/api/getUserCreds';
...
export const fetchUserEmail = async (username, userJwt) => {
  const endpoint = 'https://onlypostsai.com/api/getemail';
...
export const getBillingPortal = async (customerId, userJwt) => {
  const endpoint = 'https://onlypostsai.com/api/billing_session_url';
...
export const submitContactForm = async (contactFormData) => {
  const endpoint = 'https://onlypostsai.com/api/contactFormSubmit';
